import { signInCosmosWallet, getCosmosBalanceAction } from "./sifWalletActions";
...
describe("connectToWallet", () => {
  // XXX: Not sure it makes sense to test an external lib?
  ...
  // expect(mnemonicIsValid(generateMnemonic())).toEqual(true);
  // });
